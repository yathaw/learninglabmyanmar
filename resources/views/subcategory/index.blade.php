...
<x-backend>
  ...
  <h1 class="h3 mb-3"> Subcategory List </h1>
      ...
      <div class="card">
        <div class="card-header">
          <h5 class="card-title mb-0"> All Lists 
            ...
            <a href="{{ route('subcategory.create') }}" class="btn custom_primary_btnColor float-right" ><i class="align-middle fas fa-plus"></i></a>
