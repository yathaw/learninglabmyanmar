<x-frontend>
    ...
    <section class="currentCourse section-bg">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="d-inline-block"> Newest Courses</h3>

                    <p class="float-right d-inline-block "> <a href="{{ route('courses') }}" class="custom_primary_Color"> See More <i class="icofont-rounded-double-right"></i>  </a> </p>
                                                ...
                                                @endphp
                                                    ...
                                                    @if($count_sale > 0)
                                                        @foreach(Auth::user()->sales as $sales)
                                                            @foreach($sales->courses as $newest_course_sale)
                                                            

                                                                @if($newest_course_sale->pivot->course_id == $newest_course->id && $newest_course_sale->pivot->status == 0)

                                                                    <button disabled="disabled" class="btn custom_primary_btnColor mt-3">Pending</button>

                                                                @elseif($newest_course_sale->pivot->course_id == $newest_course->id && $newest_course_sale->pivot->status == 1)
    ...
    <section class="currentCourse">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="d-inline-block"> Top Courses</h3>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="d-grid gap-2 col-6 mx-auto">
                                                ...
                                                @endphp
                                                    ...
                                                    @if($count_sale > 0)
                                                        @foreach(Auth::user()->sales as $sales)
                                                            @foreach($sales->courses as $top_course_sale)
                                                            

                                                                @if($top_course_sale->pivot->course_id == $top_course->id && $top_course_sale->pivot->status == 0)

                                                                    <button disabled="disabled" class="btn custom_primary_btnColor mt-3">Pending</button>

                                                                @elseif($top_course_sale->pivot->course_id == $top_course->id && $top_course_sale->pivot->status == 1)
                                                                    <button disabled="disabled" class="btn custom_primary_btnColor mt-3">Purched</button>
                                                                @endif
                                                            @endforeach
                                                        @endforeach
