...
@endif
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary"> Update Exiting Instructor Change Password
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('updatepassword',$user->id)}}" enctype="multipart/form-data" id="example-form">
                @csrf
