		    	...
		    	<div class="card border-0 shadow p-3 mb-5 bg-white rounded">
	                ...
	                <div class="card-body">
	                	<div class="wizard-content">
                            <form id="example-form" action="{{ route('instructor_reg') }}" class="tab-wizard wizard-circle wizard clearfix g-3" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <section class="pt-3">
                                    <div class="row form-group ">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control required" id="headlineId" placeholder="Your Headline" name="headline">
                                        </div>
                                    </div>
                                    	...
                                    	<div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
											...
											<label class="profileCard">
											   	...
											   	<div class="card border-0 shadow-sm p-3 bg-white rounded">
											    	<input name="profile" class="radio" type="radio" value="{{ $profile }}">
