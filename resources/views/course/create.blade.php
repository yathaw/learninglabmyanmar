            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="row">
                            <div class="offset-xl-4 col-xl-4 offset-xl-4 offset-lg-4 col-lg-4 offset-lg-4 offset-md-3 col-md-6 offset-md-3 col-sm-12 col-12 text-center">
                                ...
                                <a class="btn custom_primary_btnColor btn-lg" href=""> Create Teacher  </a>
